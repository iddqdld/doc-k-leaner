...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab }) => {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-[radial-gradient(circle_at_top,_#1a1028_0,_#0f0f17_48%,_#0f1219_100%)]' : 'bg-[radial-gradient(circle_at_top,_#f8f4ff_0,_#fdfdfd_48%,_#f4f8ff_100%)]'}`}>
      {/* Mobile top bar */}
        ...
        <div className="px-4 py-4 border-t border-white/10 space-y-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-violet-200/60 hover:text-white transition-colors text-xs px-1 flex-1"
            >
            ...
            <button
              onClick={toggleTheme}
              className="text-violet-200/60 hover:text-white transition-colors p-1 rounded"
